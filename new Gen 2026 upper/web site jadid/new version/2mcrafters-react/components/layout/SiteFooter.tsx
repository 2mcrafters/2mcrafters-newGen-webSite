...
export function SiteFooter() {
  return (
    <footer
      id="contact"
      className="border-t border-white/5 bg-linear-to-b from-[#00315f] to-[#001428] py-12 text-sm text-slate-300 md:py-16"
    >
      <div className="mx-auto max-w-6xl space-y-10 px-6 md:px-8">
        <FadeInOnScroll>
          <div className="flex flex-col gap-10 md:flex-row md:items-start md:justify-between">
            <div className="max-w-xl space-y-3">
              <Image
                ...
                height={36}
                alt="Crafters"
                className="max-w-[210px] h-auto w-auto"
                priority
              />
          ...
          <div className="flex flex-col gap-3  border-white/10 pt-4 text-xs text-slate-500 md:flex-row md:items-center md:justify-between">
