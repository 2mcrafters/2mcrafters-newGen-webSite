      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-10 px-6 lg:flex-row lg:items-center">
        <div className="flex-1 space-y-5">
          <FadeInOnScroll className="space-y-4">
            ...
            <h2 className="text-3xl font-semibold sm:text-4xl">Passez du papier au confort du digital avec Smart RH.</h2>
            <p className="text-lg text-slate-300">
              Smart RH est notre solution de digitalisation des ressources humaines : gestion du personnel, présence,
              congés, paie et tableaux de bord en temps réel. Fini les dossiers éparpillés, place à une gestion fluide,
        ...
        <div className="flex-1">
          <div className="overflow-hidden rounded-4xl border border-white/10 bg-white/5 p-4 shadow-2xl shadow-purple-500/20">
            <Image
              src="/images/posts/services/smart-rh-dashboard.jpg"
