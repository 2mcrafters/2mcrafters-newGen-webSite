...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Blog & FAQ | CRAFTERS',
    description: blogDescription,
    url: 'https://www.2mcrafters.com/blog',
    locale: 'fr_FR',
    type: 'article',
    siteName: 'Crafters',
    images: [
  ...
  alternates: {
    canonical: 'https://www.2mcrafters.com/blog',
    languages: {
      'fr-FR': 'https://www.2mcrafters.com/blog',
      'en-US': 'https://www.2mcrafters.com/en/blog',
      'ar-MA': 'https://www.2mcrafters.com/ar/blog',
    },
  },
  robots: {
    index: true,
          ...
          <div className="mx-auto max-w-3xl text-center">
            <FadeInOnScroll className="space-y-4">
              ...
              <p className="text-lg text-slate-400">
                Nos articles décryptent les tendances du digital, du design, du développement et des
                systèmes métiers. Chaque publication est pensée pour vous apporter des insights
                concrets, des bonnes pratiques et des stratégies applicables immédiatement.
              </p>
            </FadeInOnScroll>
          </div>
        ...
        <div className="mx-auto max-w-4xl px-4 md:px-8">
          <FadeInOnScroll className="mb-16 text-center space-y-4">
            ...
            <p className="mx-auto max-w-2xl text-lg text-[#00315f]/80">
              Tout ce que vous devez savoir sur notre processus de travail, nos services et notre
              accompagnement.
            </p>
          </FadeInOnScroll>
